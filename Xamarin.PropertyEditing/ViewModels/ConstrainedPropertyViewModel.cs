...
namespace Xamarin.PropertyEditing.ViewModels
{
		...
		: PropertyViewModel<T>
	{
		...
		protected ConstrainedPropertyViewModel (TargetPlatform platform, IPropertyInfo property, IEnumerable<IObjectEditor> editors, PropertyVariation variation = null)
