...
namespace Xamarin.PropertyEditing.Tests
{
	...
	internal class EventViewModelTests
	{
		...
		public void MethodName()
		{
			...
			var ev = new EventViewModel (info.Object, new[] { editor });
		...
		public void SetMethodName()
		{
			...
			var vm = new EventViewModel (info.Object, new[] { editor.Object });
		...
		public void DisagreeingValues()
		{
			...
			var ev = new EventViewModel (info.Object, new[] { editor, editor2 });
